					...
					<div class="col-lg-8 col-md-7 col-12">
						<div class="search-bar-top">
							<div class="search-bar">
								...
								<form>
									<input name="search" placeholder="Search pr kam karna he" type="search">
						...
						<!-- <div class="col-lg-3">
							<div class="all-category">
								...
								<ul class="main-category">
									<li><a href="#">Cosmetics<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									...
									<li><a href="#">Jewellery<i class="fa fa-angle-right" aria-hidden="true"></i></a>
										<ul class="sub-category">
											<li><a href="#">Brands</a></li>
											<li><a href="#">best selling</a></li>
											<li><a href="#">top 100 offer</a></li>
                                                ...
                                                <li class="active"><a href="index.php">Home</a></li>
                                                    <li><a href="#">Shop<i class="ti-angle-down"></i></a>
                                                        <ul class="dropdown">
                                                            ...
                                                            while($row=mysqli_fetch_assoc($res)){
                                                                echo'
                                                                <li><a href="products.php?cid='.$row["cat_id"].'">'.$row["cat_name"].'</a></li>
                                                                ';
                                                            }
                                                            ?>
                                                        </ul>
